            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <div class="page-title">
                        <h4 class="mb-0 font-size-18">Perkiraan Pendapatan</h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item "><a href="javascript: void(0);">Home</a></li>
                            <li class="breadcrumb-item">Laporan</li>
                            <li class="breadcrumb-item active">Perkiraan Pendapatan</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="page-content-wrapper">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Perkiraan Pendapatan</h4>
                            <div class="row mt-4">
                                <div class="col-md-2">
    ...
    <script>
        ...
        $(function(){
            ...
            $('.search').click(function(){
                ...
                var urls='{{route('report.perkiraan_pendapatan.data')}}';
                _token = $('input[name=_token]').val();
                var id = $('#tempat_wisata').val()
                var dari = $('#dari').val()
                var sampai = $('#sampai').val()
                var url = "{{route('report.perkiraan_pendapatan.pdf',['id' => ':id', 'dari' => ':dari', 'sampai' => ':sampai'])}}";
